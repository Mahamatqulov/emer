...
//   const maxIndex = Math.ceil(services.length / itemsPerView);
...
//   return (
//     <section className="py-16 md:py-24  bg-linear-to-br from-background to-muted/50">
...
//                   </p>
//                   <button className="text-primary hover:text-primary/80 font-semibold text-sm flex items-center gap-2 group/btn">
//                     {language === "uz"
//                       ? "Batafsil"
//                       : language === "ru"
//                         ? "Подробнее"
