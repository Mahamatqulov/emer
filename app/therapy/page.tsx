...
function Therapy() {
  return (
    <div className="bg-background text-white">
      {/* HERO */}
      <section id="therapy" className="relative overflow-hidden pt-40 pb-20">
        <div
        ...
        <div className="max-w-7xl mx-auto px-4 relative">
          ...
          >
            ...
            <div className="relative rounded-2xl border border-background/10 bg-black/40 overflow-hidden">
              <motion.div
                aria-hidden
                className="pointer-events-none absolute inset-y-0 w-24 bg-gradient-to-r from-transparent via-[#4CC9F0]/10 to-transparent"
                animate={{ x: ["-10%", "110%"] }}
